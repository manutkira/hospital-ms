  ...
  <div>
    <div class="login-box">
      ...
      <form>
        ...
        <router-link class="text-xs" :to="{ name: 'LoginVue' }">
          <h1 class="text-blue-500 capitalize">Already has an account?</h1>
        </router-link>
        <a href="#" @click.prevent="register">
          ...
          <span></span>
          <span></span>
          <h1 v-if="loading === false">Submit</h1>
...
function register() {
  userStore.register(user.value).then((res: any) => {
    console.log(res);
